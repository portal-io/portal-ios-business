...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    业务层仓库PortalIosBusiness
                   DESC

  s.homepage     = "https://github.com/portal-io/portal-ios-business"
  ...
  s.source       = { :git => "https://github.com/portal-io/portal-ios-business.git", :tag => "#{s.version}" }
