...
//@property (nonatomic, strong) WVRSectionModel * recordSectionModel;
//@property (nonatomic, strong) WVRSectionModel * livingSectionModel;
//@property (nonatomic, strong) WVRSectionModel * trailerSectionModel;
//@property (nonatomic, strong) WVRSectionModel * adSectionModel;
